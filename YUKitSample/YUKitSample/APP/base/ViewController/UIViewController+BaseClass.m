...
{
    [self.navigationController.navigationBar setBackgroundImage:[UIImage imageWithColor:[UIColor redColor] size:CGSizeMake(AppWidth(), 64)] forBarMetrics:UIBarMetricsCompact];
