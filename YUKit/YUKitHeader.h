...
//spec.ios.dependency 'YUKit/foundation'
//spec.ios.dependency 'YUKit/uikit'
//spec.ios.dependency 'YUKit/base'
//spec.ios.dependency 'YUKit/services'
//spec.ios.dependency 'YUKit'
//end
//
//
...
//end
//
//#s.dependency 'YUKit/YUDBFramework/YUDBFramework.framework'
//s.source_files = 'YUKit/services/YU_*.{h,m}'
//end
//
//
//
//#s.subspec 'YUDBFramework' do |ss|
//#ss.source_files = 'YUKit/YUDBFramework/**/*.{h,m,cpp,mm,c}'
//#end
//
//
//
